module Fastlane
  module Actions
    ...
    class AfEditGithubReleaseAction < Action
      def self.run(params)
        ...
        begin
          uri = URI("https://api.github.com/repos/#{params[:owner]}/#{params[:repository]}/releases/#{params[:id]}")
      ...
      def self.available_options
        [
          ...
          FastlaneCore::ConfigItem.new(key: :id,
                                       ...
                                       is_string:true,
                                       default_value:Actions.lane_context[SharedValues::GITHUB_RELEASE_ID]),
