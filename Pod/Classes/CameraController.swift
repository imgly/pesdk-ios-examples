...
*/
@objc(IMGLYCameraController) public class CameraController: NSObject, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    public var effectFilter: ResponseFilter = NoneFilter()
