...
@objc(IMGLYCropEditorViewController) public class CropEditorViewController: SubEditorViewController {
    ...
    private let cropRectComponent = InstanceFactory.sharedInstance.cropRectComponent()
    ...
    public override func viewDidLayoutSubviews() {
        ...
        transparentRectView.frame = view.convertRect(previewImageView.imageFrame, fromView: previewImageView)
        reCalculateCropRectBounds()
    }
    ...
    private func reCalculateCropRectBounds() {
        ...
        cropRectLeftBound = (width - previewImageView.imageFrame.size.width) / 2.0
        cropRectRightBound = width - cropRectLeftBound
        cropRectTopBound = (height - previewImageView.imageFrame.size.height) / 2.0
