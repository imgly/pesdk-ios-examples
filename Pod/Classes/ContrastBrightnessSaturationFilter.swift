...
@objc(IMGLYContrastBrightnessSaturationFilter) public class ContrastBrightnessSaturationFilter : CIFilter {
...
extension ContrastBrightnessSaturationFilter: NSCopying {
