...
@objc(IMGLYFocusEditorViewController) public class FocusEditorViewController: SubEditorViewController {
    ...
    public override func viewDidLayoutSubviews() {
        ...
        circleGradientView.frame = view.convertRect(previewImageView.imageFrame, fromView: previewImageView)
        circleGradientView.centerGUIElements()
        
        boxGradientView.frame = view.convertRect(previewImageView.imageFrame, fromView: previewImageView)
